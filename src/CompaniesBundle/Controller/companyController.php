...
use CompaniesBundle\Entity\company;
...
class companyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $companies = $em->getRepository('CompaniesBundle:company')->findAll();
    ...
    {
        $company = new Company();
        $form = $this->createForm('CompaniesBundle\Form\companyType', $company);
    ...
    {
        $deleteForm = $this->createDeleteForm($company);
        $editForm = $this->createForm('CompaniesBundle\Form\companyType', $company);
