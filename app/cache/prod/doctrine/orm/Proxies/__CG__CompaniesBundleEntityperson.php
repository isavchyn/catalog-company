 ...
 */
class person extends \CompaniesBundle\Entity\person implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CompaniesBundle\\Entity\\person' . "\0" . 'id', '' . "\0" . 'CompaniesBundle\\Entity\\person' . "\0" . 'officeId', '' . "\0" . 'CompaniesBundle\\Entity\\person' . "\0" . 'companyId', '' . "\0" . 'CompaniesBundle\\Entity\\person' . "\0" . 'name', '' . "\0" . 'CompaniesBundle\\Entity\\person' . "\0" . 'phone', '' . "\0" . 'CompaniesBundle\\Entity\\person' . "\0" . 'office', '' . "\0" . 'CompaniesBundle\\Entity\\person' . "\0" . 'company');
        }
