...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/CompaniesBundle/Entity'))), 'CompaniesBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CompaniesBundle' => 'CompaniesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_eaf2904822989d115caed20d7b4c56b3b5c9fecc254165546bbbf507b618f55f');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CompaniesBundle/Resources/views'), 'Companies');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58f0e21b285d16.82077244')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CompaniesBundle' => 'CompaniesBundle\\CompaniesBundle',
            ),
            'kernel.bundles_metadata' => array(
                ...
                'CompaniesBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CompaniesBundle'),
                    'namespace' => 'CompaniesBundle',
                ),
            ),
            ...
            'database_port' => NULL,
            'database_name' => 'php_1_10_symfony',
            'database_user' => 'php-1-10',
            'database_password' => 'Foa1P3JQ',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'g',
