...
class __TwigTemplate_67b9a6c8549ee4da96cf8d702c1aed87013437072581f67e3c7f94e0b544f0c2 extends Twig_Template
{
    ...
    <table>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 15
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["office"]) ? $context["office"] : null), "company", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Address</th>
                <td>";
        // line 19
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["office"]) ? $context["office"] : null), "officeAdress", array()), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
